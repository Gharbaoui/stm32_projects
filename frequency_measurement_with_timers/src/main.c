...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
	...
	//			so to count diff  we need to multiply the diff by period ==> diff * 1/timerClock = diff/timerClock and in order to get frequency we just devide by 1 to get timerClock/diff
